package cn.cloudwalk.common.tool.ftp.sftp;
...
/**
*
* ClassName: SFTPChannel <br/>
* Description: 编写一个工具类，根据ip，用户名及密码得到一个SFTP channel对象，即ChannelSftp的实例对象，在应用程序中就可以使用该对象来调用SFTP的各种操作方法. <br/>
